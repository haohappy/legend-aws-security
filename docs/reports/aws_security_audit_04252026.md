...
### 5.A 高危用户完整清单：有 Active Key 但无 MFA 且无 IP 限制

以下 **52 个用户** 持有 Active Access Key，但既未启用 MFA 也未配置 IP 访问限制策略，属于完全无防护状态。任何一个 Key 泄露均可被攻击者从全球任意位置直接利用。

| # | IAM 用户 | Active Access Key(s) |
|---|----------|---------------------|
| 1 | `AmazonSSM_Claude_Code_Hao` | `AKIAZNVMXQFBVVKVPCMW` |
| 2 | `bankdev-zingpays` | `AKIAZNVMXQFB7EISKVOL` |
| 3 | `cuteid_ses_prod` | `AKIAZNVMXQFBY42S5GWH` |
| 4 | `ecr-backend-team` | `AKIAZNVMXQFB5ETXGYXQ` |
| 5 | `ecr-backend-team-read` | `AKIAZNVMXQFBRMICTDCY` |
| 6 | `ecr-frontend-team` | `AKIAZNVMXQFB4BWN2RPH` |
| 7 | `ecr-frontend-team-read` | `AKIAZNVMXQFB4H5ENFGU`, `AKIAZNVMXQFB5WDBGWKJ` |
| 8 | `ecr-legend-backend-team` | `AKIAZNVMXQFB3TP62FHU` |
| 9 | `ecr-legend-backend-team-read` | `AKIAZNVMXQFBW4V45KPP` |
| 10 | `ecr-legend-frontend-team` | `AKIAZNVMXQFB3XU7ZWXS` |
| 11 | `ecr-legend-frontend-team-read` | `AKIAZNVMXQFBSBJ4N46J` |
| 12 | `erc-lg-ops-data` | `AKIAZNVMXQFB7DFHNW3O` |
| 13 | `flashwire-dev-jenkins-eks-user` | `AKIAZNVMXQFB7TQZWRMY` |
| 14 | `flashwire-logs-backup` | `AKIAZNVMXQFBRSOFMPZY` |
| 15 | `flashwire-prod` | `AKIAZNVMXQFBU7OZX3JH` |
| 16 | `flashwire-publics3-devtest` | `AKIAZNVMXQFB65WFX5QK` |
| 17 | `flashwire-stag` | `AKIAZNVMXQFB6STJNR5O` |
| 18 | `inner_ses_testing` | `AKIAZNVMXQFBZOONVH7Q` |
| 19 | `jenkins-eks-user` | `AKIAZNVMXQFB33IWTM6P` |
| 20 | `legend-dev-jenkins-eks-user` | `AKIAZNVMXQFBQGZKUL7V` |
| 21 | `legend-kms-user-for-dev-safeheron` | `AKIAZNVMXQFBQ4VQEZ6Z` |
| 22 | `legend-kms-user-for-safeheron` | `AKIAZNVMXQFBUONB5S6W` |
| 23 | `legend-s3-for-legendspecial2024dev-uploading-sensitive` | `AKIAZNVMXQFBVTJGKFPF` |
| 24 | `legend-s3-for-legendspecial2024prod-uploading-sensitive` | `AKIAZNVMXQFBTRS4LDJ3` |
| 25 | `legend-s3-for-legendspecial2024sandbox-uploading-sensitive` | `AKIAZNVMXQFBWQQIB75B` |
| 26 | `legend_ses_development` | `AKIAZNVMXQFBRPEDGUVH`, `AKIAZNVMXQFBYNEUPSNJ` |
| 27 | `legend_ses_development_controller` | `AKIAZNVMXQFB47LC4OTF` |
| 28 | `legend_ses_otcdev` | `AKIAZNVMXQFBYOVPUM5L` |
| 29 | `legend_ses_production_queue` | `AKIAZNVMXQFBUNLNAW43` |
| 30 | `legend_ses_production_www` | `AKIAZNVMXQFB2KPIQP7G` |
| 31 | `legend_ses_qa` | `AKIAZNVMXQFBWNQXSHKO` |
| 32 | `legend_ses_sandbox` | `AKIAZNVMXQFB2RVWQZ4E` |
| 33 | `legend_ses_weblate_prod` | `AKIAZNVMXQFBYOMEKWEZ` |
| 34 | `legend_sns_dev` | `AKIAZNVMXQFBSR3XFWAS` |
| 35 | `legend_sns_production_www` | `AKIAZNVMXQFBVU34BK3S` |
| 36 | `lendingprod-s3` | `AKIAZNVMXQFB33OUOF2J` |
| 37 | `monitor` | `AKIAZNVMXQFB3H2DND57` |
| 38 | `netops-do-op-things-neccessary-for-services` | `AKIAZNVMXQFB4HSQMFNX` |
| 39 | `put-to-firehose` | `AKIAZNVMXQFB3C6HELA4`, `AKIAZNVMXQFBWZ6FO6R6` |
| 40 | `s3-for-lg-staging-test-deletion` | `AKIAZNVMXQFB23JIXBOY` |
| 41 | `s3dev` | `AKIAZNVMXQFBQZ3IBUOC` |
| 42 | `s3production` | `AKIAZNVMXQFBWB7VVJHR` |
| 43 | `s3sandbox` | `AKIAZNVMXQFB52H7SG6W`, `AKIAZNVMXQFB6LDH4BAH` |
| 44 | `ses-flowmind-dev` | `AKIAZNVMXQFBZ4HNR5EJ` |
| 45 | `ses-flowmind-production` | `AKIAZNVMXQFBXNHQWL7A`, `AKIAZNVMXQFBYZBPKWGJ` |
| 46 | `ses-smtp-user.20260126-flowmind` | `AKIAZNVMXQFBTHSP6BO3` |
| 47 | `ses_zing` | `AKIAZNVMXQFBZGNBWT5X` |
| 48 | `stellapay_s3_pkgupload_dev` | `AKIAZNVMXQFBXAX5GLG6` |
| 49 | `stellapay_s3_pkgupload_prod` | `AKIAZNVMXQFBZV7SSXPQ` |
| 50 | `stellapay_ses_prod` | `AKIAZNVMXQFB6ZDM7UO7`, `AKIAZNVMXQFBUFFEO6EA` |
| 51 | `test-opensearch-serverless` | `AKIAZNVMXQFB2E56JEMX` |
| 52 | `zing_s3_prod` | `AKIAZNVMXQFBQPMKUGV3` |

**已有防护的用户（不在上表中）**：
- `legend-security-hao` — 有 IP 限制策略（`DenyWithoutIPorMFA`）
- `kaiqiang.qiao` — 有 MFA
- `netops_tao` — 有 MFA

**Console 登录**：所有无 MFA 的用户均未配置 Console 登录权限（login profile），Console 入口安全。**风险面集中在 Access Key 的程序化访问。**
